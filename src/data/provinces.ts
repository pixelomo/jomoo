...
/**
 * Japan's 47 prefectures, in the standard JIS X 0401 order.
 * `value` is the romanised name and is what gets stored on the registration
 * and passed to the client's CRM.
 */
