...
const models = [
  { slug: 'shower-set', name: 'Shower Set', label: '[ shower set ]' },
]
      ...
      <div className="jm-sec-inner" style={{ paddingTop: 80, paddingBottom: 80 }}>
        ...
        <div className="jm-listing-grid-3">
          {models.map(m => (
            <Link
              key={m.slug}
              href={`/products/shower-set/${m.slug}`}
            ...
            >
              ...
              <div style={{ padding: '20px 20px 24px' }}>
                <h3 style={{ fontSize: 17, fontWeight: 600, margin: '0 0 10px', color: 'var(--ink)' }}>{m.name}</h3>
